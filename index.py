...
def startvideo():
    ...
    global countforvideo
    global listofthreadvideo
    listofdownloadvideowindows.append('downloadwindow2{}'.format(counter2));
    listofdownloadvideowindows[counter2]=pageofvideodownload()
    listofthreadvideo.append('threadforvideo{}'.format(countforvideo))
    '''listofthreadvideo[countforvideo] = QThread()
    listofthreadvideo[countforvideo].started.connect(listofdownloadvideowindows[counter2].work)
    listofthreadvideo[countforvideo].start()
    '''
...
def startplaylist():
    ...
    global countforplaylist
    global listofthreadplaylist
    ...
    '''
    listofthreadplaylist.append('threadforvideo{}'.format(countforvideo))
    listofthreadplaylist[countforplaylist] = QThread()
    listofthreadplaylist[countforplaylist].started.connect(listofdownloadplaylistwindows[counter3].work)
    listofthreadplaylist[countforplaylist].start()
    '''
    QApplication.processEvents()
...
class pageofdownload(QWidget,FORM_CLASS2):
    ...
    def handle_progress_bar(self ,blocknum,blocksize,totalsize):
        ...
        QApplication.processEvents()
        self.progressBar.setValue(read* 100 / totalsize)
        QApplication.processEvents()
